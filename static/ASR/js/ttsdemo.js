    ...
    my_jPlayer.jPlayer({
        ...
        ended: function() {
            if($("#syntheticBtn").val() == 1)
                return;
            $("#syntheticBtn").val(4);
            $("#syntheticBtn").css("background-image","url(/static/ASR/image/btn_play_normal.png)");
        }
    });
  ...
  //  ------show toast messages ------------
    ...
    $("#syntheticBtn").click(function () {
        ...
        if ($("#syntheticBtn").val() == 1) {
            ...
            $("#syntheticBtn").css("background-image","url(/static/ASR/image/btn_synthesize_normal.png)");
            ...
            $("#syntheticBtn").css("background-image","url(/static/ASR/image/btn_pause_normal.png)");
